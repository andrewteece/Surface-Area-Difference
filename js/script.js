...
calculate.addEventListener('click', () => {
  const firstRectangle = [
    Number.parseInt(width1.value, 10),
    Number.parseInt(length1.value),
  ];
  const secondRectangle = [
    Number.parseInt(width2.value, 10),
    Number.parseInt(length2.value),
  ];
...
function calculateSurface1() {
  surface1.value =
    Number.parseInt(width1.value, 10) * Number.parseInt(length1.value, 10);
}
...
function calculateSurface2() {
  surface2.value =
    Number.parseInt(width2.value, 10) * Number.parseInt(length2.value, 10);
}
